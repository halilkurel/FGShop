...
namespace FGShop.WebApiLayer.Controllers
{
    ...
    [ApiController]
    public class ProducthasSizesController : ControllerBase
    {
        private readonly IProducthasSizeService _service;

        public ProducthasSizesController(IProducthasSizeService sliderService)
        {
        ...
        {
            var response = await _service.GetById<ResultProducthasSizeDto>(id);
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateProducthasSizeDto dto)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] CreateProducthasSizeDto dto)
        {
