...
namespace FGShop.WebApiLayer.Controllers
{
	...
	public class SlidersController : ControllerBase
	{
		...
		{
			var response = await _service.GetById<ResultSliderDto>(id);
		...
		[HttpPut]
		public async Task<IActionResult> Update([FromBody] UpdateSliderDto dto)
		{
		...
		[HttpPost]
		public async Task<IActionResult> CreateAsync([FromBody] CreateSliderDto dto)
		{
