...
namespace FGShop.WebApiLayer.Controllers
{
    ...
    public class LikesController : ControllerBase
    {
        ...
        {
            var response = await _service.GetById<ResultLikeDto>(id);
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateLikeDto dto)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] CreateLikeDto dto)
        {
