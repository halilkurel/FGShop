...
namespace FGShop.WebApiLayer.Controllers
{
    ...
    public class UserAddressesController : ControllerBase
    {
        ...
        {
            var response = await _service.GetById<ResultUserAddressDto>(id);
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateUserAddressDto dto)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] CreateUserAddressDto dto)
        {
