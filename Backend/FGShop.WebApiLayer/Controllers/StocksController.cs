...
namespace FGShop.WebApiLayer.Controllers
{
    ...
    public class StocksController : ControllerBase
    {
        ...
        public StocksController(IStockService sliderService)
        {
        ...
        {
            var response = await _service.GetById<ResultStockDto>(id);
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] CreateStockDto dto)
        {
