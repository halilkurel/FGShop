...
namespace FGShop.DataAccessLayer.Migrations
{
    ...
    [Migration("20241205163933_newstockMig2")]
    partial class newstockMig2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FGShop.EntityLayer.Entities.ProducthasColorAndProducthasSizeStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ProducthasSizeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProducthasSizeId");

                    b.ToTable("producthasColorAndProducthasSizeStocks");
                });
            ...
            modelBuilder.Entity("FGShop.EntityLayer.Entities.ProducthasColorAndProducthasSizeStock", b =>
                {
                    b.HasOne("FGShop.EntityLayer.Entities.ProducthasColor", "ProducthasColor")
                        .WithMany("producthasColorAndProducthasSizeStocks")
                        .HasForeignKey("ProducthasColorId");

                    b.HasOne("FGShop.EntityLayer.Entities.ProducthasSize", "ProducthasSize")
                        .WithMany("producthasColorAndProducthasSizeStocks")
                        .HasForeignKey("ProducthasSizeId");

                    b.Navigation("ProducthasColor");

                    b.Navigation("ProducthasSize");
                });
            ...
            modelBuilder.Entity("FGShop.EntityLayer.Entities.ProducthasColor", b =>
                {
                    b.Navigation("producthasColorAndProducthasSizeStocks");
                });
